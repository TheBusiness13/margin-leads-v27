MARGINBUSINESS LEADS v2.7.1 — CONNECTED PRIVATE BETA SETUP
...
6. During development, keep the current Vercel production URL in Supabase Authentication > URL Configuration.
   Add the custom domain only after the beta build is stable.
7. The original MarginBusiness Leads logo is included at assets/marginbusiness-leads-logo.png.
